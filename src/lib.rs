...
mod tests {
    ...
    fn test_from_bits() {
        ...
        assert!(Flags::from_bits(0b1) == Some(Flags::FLAG_A));
        assert!(Flags::from_bits(0b10) == Some(Flags::FLAG_B));
        assert!(Flags::from_bits(0b11) == Some(Flags::FLAG_A | Flags::FLAG_B));
        assert!(Flags::from_bits(0b1000) == None);

        assert!(AnotherSetOfFlags::from_bits(!0_i8) == Some(AnotherSetOfFlags::ANOTHER_FLAG));
    }

    #[test]
    fn test_from_bits_truncate() {
        assert!(Flags::from_bits_truncate(0) == Flags::empty());
        assert!(Flags::from_bits_truncate(0b1) == Flags::FLAG_A);
        assert!(Flags::from_bits_truncate(0b10) == Flags::FLAG_B);
        assert!(Flags::from_bits_truncate(0b11) == (Flags::FLAG_A | Flags::FLAG_B));
        assert!(Flags::from_bits_truncate(0b1000) == Flags::empty());
        assert!(Flags::from_bits_truncate(0b1001) == Flags::FLAG_A);
    ...
    fn test_insert() {
        ...
        assert!(e3 == AnotherSetOfFlags::ANOTHER_FLAG);
    }
    ...
    fn test_operators() {
        ...
        assert!((e1 - e2) == Flags::FLAG_A);       // set difference
        assert!(!e2 == Flags::FLAG_A);             // set complement
        assert!(e1 ^ e2 == Flags::FLAG_A | Flags::FLAG_B); // toggle
        let mut e3 = e1;
        e3.toggle(e2);
        assert!(e3 == Flags::FLAG_A | Flags::FLAG_B);
